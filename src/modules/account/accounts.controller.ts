...
export class AccountsController {
  ...
  @Put("admin-verify/:id")
  async verifyByAdmin(@Param("id", ParseIntPipe) id: number): Promise<any> {
    return await this.accountsService.verifyByAdmin(id);
  }
  ...
  @Get("warehouse/all-db")
  @ApiOkResponse({ description: RESPONSE_EXPLAINATION.GET_ACCOUNT })
  getWarehousesAllDb(): Promise<any> {
    return this.accountsService.getWarehousesAllDb();
  }
